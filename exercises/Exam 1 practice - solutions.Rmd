...
**Code (3 points):**
```{r}
dat %>% group_by(race) %>% summarize(mean=mean(bail_amount),
                                     median=median(bail_amount))
```

**Text answer (2 points):**

Black individuals have a median bail amount of \$1,237.97 and White individuals have a median bail amount of \$9,078.23. This is a large difference. Hispanic individuals also have a low median bail amount at $2,793.94. Other is somewhere in between, but it's difficult to say more about this groups since we do not know its composition. 
